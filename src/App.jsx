...
// External Links
const HEADWAY_URL =
  "https://care.headway.co/providers/eva-gillespie-2?utm_source=pem&utm_medium=direct_link&utm_campaign=91902";
...
const GOOGLE_DIRECTIONS =
  "https://www.google.com/maps/dir/?api=1&destination=5215%20N%20Sabino%20Canyon%20Rd%2C%20Tucson%2C%20AZ%2085750";

// 🎧 Podcasts (universal, percent-encoded search links)
const PODCASTS = [
  {
    title: "Navigating Narcissism with Dr. Ramani",
    apple:
      "https://podcasts.apple.com/us/search?term=Navigating%20Narcissism%20Dr%20Ramani",
    spotify:
      "https://open.spotify.com/search/Navigating%20Narcissism%20Dr%20Ramani",
  },
  {
    title: "The Covert Narcissism Podcast",
    apple:
      "https://podcasts.apple.com/us/search?term=The%20Covert%20Narcissism%20Podcast",
    spotify:
      "https://open.spotify.com/search/The%20Covert%20Narcissism%20Podcast",
  },
  {
    title:
      "The Narcissistic Abuse & Trauma Recovery Podcast (Caroline Strawson)",
    apple:
      "https://podcasts.apple.com/us/search?term=Caroline%20Strawson%20Narcissistic%20Abuse%20%26%20Trauma%20Recovery",
    spotify:
      "https://open.spotify.com/search/Caroline%20Strawson%20Narcissistic%20Abuse%20Trauma%20Recovery",
  },
  {
  ...
  },
  {
    ...
    apple:
      "https://podcasts.apple.com/us/search?term=Waking%20Up%20to%20Narcissism%20Tony%20Overbay",
    spotify:
      "https://open.spotify.com/search/Waking%20Up%20to%20Narcissism%20Tony%20Overbay",
  },
];
...
const YOUTUBES = [
  ...
  {
    title: "Surviving Narcissism (YouTube)",
    url: "https://www.youtube.com/@SurvivingNarcissism",
  },
];
  ...
  return (
    <main className="min-h-screen bg-black text-white flex flex-col items-center p-6">
      ...
      <header className="w-full max-w-md text-center mt-4">
        <img
          src={logo}
          alt="Forza Behavioral Health"
          className="mx-auto w-28 h-28 rounded-2xl shadow"
        />
        <h1 className="text-2xl font-semibold tracking-tight mt-3">
          Forza Behavioral Health
        </h1>
        <p className="text-sm text-neutral-300 mt-1">
          Grounded support, modern voice.
        </p>
      </header>
      ...
      <footer className="w-full max-w-md text-center text-[11px] text-neutral-400 mt-8 mb-6">
        <button
          ...
          className="underline decoration-neutral-600 hover:decoration-white"
        >
          Home
        </button>
...
function TileButton({ href, children, onClick }) {
  const base =
    "rounded-2xl border border-neutral-700 bg-white text-black p-4 text-center shadow-sm hover:shadow-md active:scale-[.99]";
  if (href) {
    return (
...
function Home({ setPage }) {
  return (
    <>
      ...
      <section className="w-full max-w-md mt-6 grid grid-cols-2 gap-3">
        ...
        <TileButton href={"mailto:Admin@forzabehavioralhealth.com"}>
          ...
          <div className="text-xs text-neutral-600 mt-1">
            Admin@forzabehavioralhealth.com
          </div>
        </TileButton>
      ...
      <section className="w-full max-w-md mt-8">
        <div className="rounded-2xl border border-neutral-800 bg-neutral-900/60 p-4 text-center text-sm text-neutral-300">
          <p>📱 Save this app to your phone:</p>
          <p className="mt-1">
            On iPhone: Share → <span className="font-semibold">Add to Home Screen</span><br />
            On Android: Menu → <span className="font-semibold">Add to Home Screen</span>
          </p>
        </div>
      </section>
    </>
...
function Forum({ setPage }) {
  return (
    <section className="w-full max-w-md mt-6">
      <button
        onClick={() => setPage("home")}
        className="text-sm text-neutral-300 underline decoration-neutral-600 hover:decoration-white"
      >
        ← Back to Home
      </button>

      {/* 🏷️ Announcement Banner */}
      <div className="rounded-2xl border border-emerald-400 bg-emerald-600/20 text-emerald-200 p-3 text-sm font-medium mb-4">
        📣 Announcement: Live group chat every <span className="font-semibold text-white">Sunday @ 5pm</span>!
      </div>

      <h2 className="text-xl font-semibold mt-2">The Feelings Forum</h2>
      <p className="text-sm text-neutral-300 mt-1">
        Our safe, supportive live chat space and resource hub. Each month we
        focus on a new theme—this month:{" "}
        <span className="font-semibold text-white">Escaping Narcissism</span>.
      </p>
      ...
      >
        Join the Feelings Forum on Patreon
      </a>
      ...
      <p className="text-[11px] text-neutral-400 mt-6">
        Can’t join live? Subscribe on Patreon for monthly recaps and upcoming
        themes.
      </p>
    </section>
  );
